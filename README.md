...
1. 下のローダーを、ブックマークの **URL（アドレス）欄**に貼り付けて保存します。
   ...
   ```
   javascript:void function(d){var s=d.createElement("script");s.src="https://cdn.jsdelivr.net/gh/Yasukei404/popn-medal@main/medal-census.js?_="+Date.now();d.head.appendChild(s)}(document);
   ```
...
- 未解禁の曲は eagate に表示されないため、合計にも反映されません。
