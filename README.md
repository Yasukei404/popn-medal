...
1. 下のローダーを、ブックマークの **URL（アドレス）欄**に貼り付けて保存します。
   ...
   ```
   javascript:void function(d){var s=d.createElement("script");s.src="https://cdn.jsdelivr.net/gh/Yasukei404/popn-medal@v2/medal-census.js";d.head.appendChild(s)}(document);
   ```
